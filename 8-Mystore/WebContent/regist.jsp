...
<div id="reg_main">
        <div class="main_left">
            <form action="/8-Mystore/RegistServlet" id="reg_form" method="post">
                <div>
                    <label>用户名</label>
                ...
                <div class="check_box">
                    ...
                    <img src="/8-Mystore/CheckCodeServlet" onclick="change(this)">
                </div>
...
<script type="text/javascript">
	function change(obj) {
		obj.src = "/8-Mystore/CheckCodeServlet?time=" + new Date().getTime();
	}
	...
	function checkData() {
        ...
        var pnone =document.getElementById("phone");
